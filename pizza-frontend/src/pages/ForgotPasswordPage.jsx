    ...
    <>
      ...
      <div style={s.page}>
        ...
        <div style={s.left}>
          ...
          <div style={s.heroLabel}>Account recovery</div>
          <h1 style={s.heroTitle}>
            FORGOT YOUR<br/>
            <span style={s.heroTitleOrange}>PASSWORD</span>?
          </h1>
          <p style={s.heroDesc}>No worries — enter your email and we'll send you a link to reset your password and get back to ordering.</p>
          <div style={s.features}>
            <div style={s.feature}><div style={s.featureDot}></div>Secure reset link</div>
            <div style={s.feature}><div style={s.featureDot}></div>Expires in 1 hour</div>
          </div>
        ...
        <div style={s.right}>
          ...
          <div style={s.formSub}>Enter the email address associated with your account and we'll send a reset link.</div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={s.inputGroup}>
                ...
                <div style={s.inputWrap}>
                  <i className="ti ti-mail" style={s.inputIcon}></i>
